...
public class BitWiseOperatorsOR {
    public static void main(String[] args) {
        ...
        System.out.printf("%s | %s = %s (representação binária)\n", value1, value2, result, binaryResult);

    }
    /*
    no caso o operador lógico "|" OR ele retona quando é verdadeiro
    0 = false
    1 = true
    110 = 6
    101 = 5
